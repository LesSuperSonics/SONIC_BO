package com.capgemini.candidateorganizationsystem.security;


import com.capgemini.candidateorganizationsystem.SpringApplicationContext;
import com.capgemini.candidateorganizationsystem.dto.UserDto;
import com.capgemini.candidateorganizationsystem.requests.UserLoginRequest;
	...
	public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res)
	  ...
	  @Override
	    protected void successfulAuthentication(HttpServletRequest req,
	        ...
	        res.addHeader("user_id", String.valueOf(userDto.getId()));
